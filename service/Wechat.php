...
class Wechat{
	# appid
	public static $appid = 'wx30f4a69764a017c2';
	# appsecret
	public static $appsecret = 'bfe842b38a68b9e0aa22985f31268214';
	# mch_id
	public static $mch_id;
	# Token
	public static $token = 'jinxin';
	# key
	public static $key;
	# 缓存Dricer
	...
	public static function get_Web_user_Access_Token($callBack){
		...
		# 判断是否为微信的回调
		if(empty($_GET['code'])){
			//dump(self::$client->getAuthorizeUrl());die();
